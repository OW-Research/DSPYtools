...
The goal is to make sure that software development in next phases is guided by scientist's needs, and that the design of an architecture for data and software sharing can be incorporated into scientists' workflows with minimal or no disruption. For instance, there may be results that can be shared and results that must be kept confidential: private data needs to be anonymized; temporary results confirmed.
...
\begin{itemize}
    ...
    \item Issues and limitations in existing data management systems, including issues related to data formatting, metadata generation, and sharing.
\end{itemize}
